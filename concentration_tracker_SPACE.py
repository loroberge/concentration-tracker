...
class ConcentrationTrackerSPACE(Component):
    ...
    **Required Software Citation(s) Specific to this Component**
    ...
    def concentration_watercolumn_and_bed(self, dt, SPACE):
        ...
        for node_id in stack_flip_ud_sel:
            ...
            # Calculate watercolumn concentration
    ...
    def run_one_step(self, dt, SPACE):
        """
        ...
        self.concentration_watercolumn_and_bed(dt, SPACE)
